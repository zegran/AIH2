...
The present result, that measurement apparatus alone explains $43\%$ and temperature
control explains $8\%$ of between-study yield variance in aluminum hydrolysis, places
this field in the same category. The
...
between-study variance contribution each field carried in our analysis: measurement
apparatus is listed first because it was the single largest source ($R^2\!=\!0.43$);
temperature control and water type follow because they contribute smaller but nonzero
...
carried here (Section~\ref{sec:variance_decomp}); measurement apparatus is the largest
single source ($R^2\!=\!0.43$).}
\label{tab:mireport}
\begin{tabular}{lll}
\toprule
Field & Report & Between-study $R^2$ here \\
\midrule
Measurement method   & water displacement / pressure / GC / mass-flow / other & 0.43 \\
Temperature control  & method (isothermal bath / self-heating) + setpoint & 0.08 \\
